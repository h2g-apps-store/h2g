    ...
    <main>
      ...
      <section className="bg-[#d6f4e2] p-20">
        <div className="grid grid-col gap-10">
          <Link href="/blog" className="bg-white flex shadow-xl rounded-lg">
            <div className="bg-[url('/image.jpeg')] bg-cover  h-full w-[1000px]"></div>
          ...
          <Link href="/blog" className="bg-white flex shadow-xl rounded-lg">
            <div className="bg-[url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSVGHL9r9OucwArH8yO3rEDPryG4V3tSCBw-w&usqp=CAU')] bg-cover  h-full w-[1000px]"></div>
            <div className="p-10 space-y-2">
              <h1 className="text-4xl font-bold">
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
              </h1>
        ...
        <div className="pt-8 flex items-center justify-center gap-3">
          <div className="p-3 bg-[#a1d9b9] rounded text-white font-bold">
            {"<"}
          </div>
          <div className="flex gap-1">
            <div className="p-3 bg-[#313b57] text-white rounded">15</div>
            <div className="p-3 bg-[#313b57] text-white rounded">10</div>
          </div>
          <div className="p-3 bg-[#a1d9b9] text-white rounded font-bold">
            {">"}
          </div>
        </div>
      </section>
